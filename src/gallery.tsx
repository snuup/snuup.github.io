...
export let Gallery = () => (
    <Fragment>
        <article id="gallery" onClick="toggleexplain()">
            ...
            <section class="sputnik3" id={Project.Sputnik4}>
            ...
            <section class="sputnik7" id={Project.Sputnik4}>
                ...
                <div class="fin">
                    <div class="end-text">
                        <div>
                            ...
                            <span id="rewind">begin</span>.
                        </div>
                    </div>
                    <div class="controls">
                        <table>
                            <KeyMapDescription op="previous slide" keys="left-arrow">
                                swipe, mousewheel, scrollbar
                            </KeyMapDescription>
                            <KeyMapDescription op="next slide" keys="right-arrow enter">
                                swipe, mousewheel, scrollbar
                            </KeyMapDescription>
                            <KeyMapDescription op="first slide" keys="pos1">
                                scrollbar
                            </KeyMapDescription>
                            <KeyMapDescription op="last slide" keys="end">
                                scrollbar
                            </KeyMapDescription>
                            <KeyMapDescription op="close gallery" keys="esc">
                                close-button (top right corner)
                            </KeyMapDescription>
                            <KeyMapDescription op="toggle explanation" keys="space">
                                click or touch page
                            </KeyMapDescription>
                        </table>
                    </div>
