...
let Overview = () => (preact.h("article", { id: "overview" },
    preact.h("header", null,
        ...
        preact.h("cite", null,
            ...
            preact.h("p", null, "why should one write uppercase if one cannot speak uppercase?"),
            preact.h("p", null,
                preact.h("br", null),
                "(bauhaus)"))),
    preact.h(Section, { project: Project.TV, header: "tv production" },
        ...
        preact.h(GalleryLink, { img: "https://res.cloudinary.com/snuu/image/upload/f_auto/v1629150958/tv-small", alt: "tv application small" })),
...
let Explain = ({ children }) => (preact.h("div", { class: "explainbox" },
...
let Gallery = () => (preact.h(preact.Fragment, null,
    preact.h("article", { id: "gallery" },
        ...
        preact.h("section", { class: "tv", id: Project.TV },
            ...
            preact.h(FullImg, { src: "https://res.cloudinary.com/snuu/image/upload/c_scale,f_auto,q_80/v1629150961/tv-large", alt: "tv application screenshot large" }),
        ...
        preact.h("section", { class: "sputnik1", id: Project.Sputnik4 },
            ...
            preact.h(Explain, null,
                ...
                preact.h("p", null,
                    "i always found skeuomorphism in screen design too dominant, underestimating users. the 5 buttons in the header are the only slight skeumorph elements, justified as a contrast to the remainung ui, which was flat. this was in 2003, many years later flat ",
                    preact.h("span", { class: "strike" }, " was "),
                    " is en vogue. same with the large fotos that set the mood here."))),
        preact.h("section", { class: "sputnik3", id: Project.Sputnik4 },
        ...
        preact.h("section", { class: "sputnik7", id: Project.Sputnik4 },
